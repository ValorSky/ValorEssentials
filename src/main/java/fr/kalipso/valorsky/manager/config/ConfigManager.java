package fr.kalipso.valorsky.manager.config;

import fr.kalipso.valorsky.manager.Manager;
import fr.kalipso.valorsky.utils.config.BukkitConfiguration;
...
public class ConfigManager extends Manager {
    ...
    private BukkitConfiguration mailConfig;
    ...
    public void loadConfigs()
    {
        ...
        chatConfig.load();
        mailConfig = new BukkitConfiguration(this.getInstance(), "mail", this.getInstance().getDataFolder().getAbsolutePath());
        mailConfig.load();
    }
    ...
    public YamlConfiguration get(String name)
    {
        ...
        {
            return mailConfig.getImplementation();
        }
